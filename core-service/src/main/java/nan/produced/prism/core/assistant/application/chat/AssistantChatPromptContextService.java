...
public class AssistantChatPromptContextService {
    ...
    public record PromptContext(AssistantRagContextService.RagContext rag, List<Message> messages) {
    }
    ...
    public PromptContext build(String userText,
        ...
        messages.add(new Message("system", promptBuilder.buildSystemPrompt(rag, toolResultForPrompt)));
