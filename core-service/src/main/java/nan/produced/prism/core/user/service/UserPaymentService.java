...
import nan.produced.prism.core.integration.payment.client.PaymentInternalClient.GetSubscriptionRequest;
...
public class UserPaymentService {
    ...
    public PaymentCreateOrderResponse createOrder(PaymentCreateOrderRequest request) {
        ...
        ApiResponse<PaymentCreateOrderResponse> response = paymentInternalClient.createOrder(
        ...
        PaymentCreateOrderResponse remote = requirePaymentSuccess(response, "创建订单失败");
    ...
    public PaymentOrderDetailResponse getOrder(UUID orderId) {
        UUID userId = requireCurrentUserUuid();

        ApiResponse<PaymentOrderDetailResponse> response = paymentInternalClient.getOrder(orderId);
        PaymentOrderDetailResponse remote = requirePaymentSuccess(response, "查询订单失败");
    ...
    public PaymentOrderDetailResponse cancelOrder(UUID orderId) {
        UUID userId = requireCurrentUserUuid();

        ApiResponse<PaymentOrderDetailResponse> response = paymentInternalClient.cancelOrder(orderId);
        PaymentOrderDetailResponse remote = requirePaymentSuccess(response, "取消订单失败");
