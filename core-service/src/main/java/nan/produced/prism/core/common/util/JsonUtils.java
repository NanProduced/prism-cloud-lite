 ...
 * ({@link InfraException})，简化了调用方的代码。</li>
 * </ul>
 *
 * <p><b>基本用法:</b></p>
 * <pre>{@code
...
public class JsonUtils {
    ...
    public static String toJson(Object obj) {
        ...
        try {
            ...
            throw new InfraException(ErrorCode.JSON_SERIALIZATION_EXCEPTION, e);
        }
    }
     ...
     * @throws InfraException 如果序列化过程中发生错误。
     */
     ...
     * @throws InfraException 当JSON格式不正确或路径格式错误时抛出
     */
    ...
    public static int getIntValue(String json, String path, int defaultValue) {
        try {
            ...
            return defaultValue;
        } catch (NumberFormatException | InfraException e) {
            return defaultValue;
        }
    }
     ...
     * @throws InfraException 当JSON解析失败或路径格式错误时抛出
     */
    private static JsonNode navigateToPath(String json, String path) {
        ...
        if (StringUtils.isBlank(path)) {
            throw new InfraException(ErrorCode.JSON_SERIALIZATION_EXCEPTION, "路径不能为空");
        }
        ...
        try {
            ...
            throw new InfraException(ErrorCode.JSON_SERIALIZATION_EXCEPTION, "JSON解析失败", e);
        }
    }
