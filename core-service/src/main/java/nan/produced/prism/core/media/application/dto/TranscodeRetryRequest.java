 ...
 */
@Data
@Schema(name = "TranscodeRetryRequest", description = "转码任务重试请求")
public class TranscodeRetryRequest {

    /**
     * 源素材ID
     */
    @NotBlank(message = "assetId is required")
    @Schema(description = "源素材ID", requiredMode = Schema.RequiredMode.REQUIRED)
