...
import nan.produced.prism.auth.security.console.ConsoleBootstrapProps;
...
@Configuration
@EnableConfigurationProperties({SecurityProps.class, OtpProps.class, PnvProps.class, GoogleOAuthProps.class, ConsoleBootstrapProps.class})
