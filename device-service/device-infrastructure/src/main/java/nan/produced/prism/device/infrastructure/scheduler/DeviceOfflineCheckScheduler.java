package nan.produced.prism.device.infrastructure.scheduler;
...
public class DeviceOfflineCheckScheduler {
     ...
     */
    @Scheduled(fixedDelayString = "#{@deviceConfigPort.getDeviceOfflineCheckInterval()}",
                initialDelayString = "#{@deviceConfigPort.getDeviceOfflineInitialDelay()}")
     ...
     */
    @Scheduled(fixedRateString = "#{@deviceConfigPort.getDeviceCalibrationInterval()}",
        ...
        try {
            ...
            redisTemplate.execute(new SessionCallback<Object>() {
                ...
                public Object execute(RedisOperations operations) throws DataAccessException {
                    ...
                    operations.expire(statusKey, Duration.ofSeconds(deviceConfigPort.getReconnectCacheTtl()));
            ...
            log.debug("DeviceStatusScheduler - 校准中设备离线处理成功: deviceId={}, reconnectTtl={}s",
                    deviceId, deviceConfigPort.getReconnectCacheTtl());
            return true;
    ...
    /**
     * 直接重建，无需diff
     * @param correctOnlineDevices 需要校准的在线设备
     */
