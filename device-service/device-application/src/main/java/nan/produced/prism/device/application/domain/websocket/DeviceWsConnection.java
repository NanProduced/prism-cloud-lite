...
@NoArgsConstructor
@Builder
public class DeviceWsConnection {
     ...
     * @return 连接封装
     */
    public static DeviceWsConnection create(Long deviceId, WebsocketSession session, ProtocolVersion protocolVersion) {
        LocalDateTime now = LocalDateTime.now();
        DeviceWsConnection connection = new DeviceWsConnection();
