package nan.produced.prism.device.application.dto.websocket.v11;
...
public class V11WebsocketMessage {
     ...
     */
    public static V11WebsocketMessage generateErrorContent(V11WebsocketErrorType errorType, Integer messageId, String info) {
        V11WebsocketMessage websocketMessage = new V11WebsocketMessage(V11WebsocketMessageType.ERROR.getId(), messageId);
     ...
     * @return 包含错误信息的V11WebsocketMessage对象
     */
    public static V11WebsocketMessage generateErrorContent(V11WebsocketErrorType errorType, String info) {
        V11WebsocketErrorMessage errorMessage = new V11WebsocketErrorMessage(errorType.getId(), info);
        return new V11WebsocketMessage(V11WebsocketMessageType.ERROR.getId(), errorMessage);
    }
     ...
     * @return 包含错误信息的V11WebsocketMessage对象
     */
    public static V11WebsocketMessage generateErrorContent(V11WebsocketErrorType errorType) {
