 ...
 */
@Getter
public enum V11WebsocketMessageType {
    ...
    V11WebsocketMessageType(Integer id, String type) {
        this.id = id;
        this.type = type;
    }

    public static V11WebsocketMessageType fromId(Integer id) {
        for (V11WebsocketMessageType type : V11WebsocketMessageType.values()) {
