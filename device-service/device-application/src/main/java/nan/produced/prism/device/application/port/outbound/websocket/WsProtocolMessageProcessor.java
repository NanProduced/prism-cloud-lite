 ...
 * @author Nan
 */
public interface WsProtocolMessageProcessor {
     ...
     * @return 处理结果
     */
    TextMessageProcessResult processTextMessage(WsMessageProcessingContext context);
     ...
     */
    default void onConnectionEstablished(WsMessageProcessingContext context) {
        // 默认空实现，V1.0等协议无需特殊处理
    }
