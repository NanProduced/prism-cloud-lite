...
public class TimeUtils {
    ...
    public static LocalDateTime convertTimestampToUtc(Long timestamp) {
        ...
        try {
            ...
            throw new TechException(TechErrorCode.TIME_FORMAT_TRANSLATE_FAILED);
        }
    }
    ...
    public static LocalDateTime convertStringToLocalDateTime(String timeStr, String pattern) {
        ...
        try {
            ...
            throw new TechException(TechErrorCode.TIME_FORMAT_TRANSLATE_FAILED, "Failed to parse string to LocalDateTime.");
        }
    }
